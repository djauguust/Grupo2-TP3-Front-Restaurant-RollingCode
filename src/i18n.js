  ...
  resources: {
    en: {
      translation: {
        ...
        ReservaEditadaExitosamente: "The changes to your reservation were saved successfully",
        ...
        CrearFechaNoDisponible:"Are you sure you want to create the unavailable date?",
        EliminarLuego: "You can delete this later",
        EliminarFechaNoDisponible: "Do you really want to delete the unavailable date?",
        ActualizarDatosRestaurante: "Are you sure you want to update the restaurant's data?",
        RestauranteEditadoExito: "Restaurant successfully modified",
        RestauranteCambiosGuardados: "The changes to your restaurant were saved successfully.",
        SeguroEditarUsuario: "Are you sure you want to edit the user?",
        UsuarioModificadoExito: "User successfully modified",
        ModificacionesRealizadas: "Your modifications have been successfully integrated",
    ...
    es: {
      translation: {
        ...
        ReservaEditadaExitosamente: "Los cambios en tu reserva fueron guardados exitosamente",
        ...
        CrearFechaNoDisponible: "Esta seguro que desea crear la fehcha no disponible?",
        EliminarLuego: "Esto lo puede eliminar luego",
        EliminarFechaNoDisponible: "¿Realmente deseas eliminar la fecha no disponible?",
        EliminarSinProblema: "Puede crear la fecha nuevamente una vez la elimine",
        ActualizarDatosRestaurante: "Esta seguro que desea actualizar los datos del restaurante?",
        RestauranteEditadoExito: "Restaurant modificado con éxito",
        RestauranteCambiosGuardados: "Los cambios en tu restaurante fueron guardados exitosamente",
        SeguroEditarUsuario: "Esta seguro que desea editar el usuario?",
        UsuarioModificadoExito: "Usuario modificado con éxito",
        ModificacionesRealizadas: "Tus modificaciones ya fueron integradas exitosamente",
